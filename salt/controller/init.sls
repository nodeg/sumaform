...
ruby_set_rake_version:
  cmd.run:
    - name: update-alternatives --set rake /usr/bin/rake.ruby.ruby3.4

ruby_set_bundle_version:
  cmd.run:
    - name: update-alternatives --set bundle /usr/bin/bundle.ruby.ruby3.4

ruby_set_rdoc_version:
  cmd.run:
    - name: update-alternatives --set rdoc /usr/bin/rdoc.ruby.ruby3.4

ruby_set_ri_version:
  cmd.run:
    - name: update-alternatives --set ri /usr/bin/ri.ruby.ruby3.4
...
install_gems_via_bundle:
  cmd.run:
    - name: bundle.ruby3.4 install --gemfile Gemfile
